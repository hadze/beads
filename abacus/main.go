// abacus is a standalone sidecar for tracking LLM session costs.
// Counting beads, one token at a time.
// Data lives in .beads/cost.db (SQLite), independent of the main beads/dolt database.
package main
...
import (
	...
	"github.com/hadze/abacus/internal/cost"
)
...
func main() {
	root := &cobra.Command{
		Use:   "abacus",
		Short: "Counting beads — LLM cost tracker for beads",
