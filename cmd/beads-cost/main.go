// beads-cost is a sidecar binary for tracking LLM session costs.
...
import (
	...
	"github.com/steveyegge/beads/internal/cost"
)
...
func findBeadsDir() string {
	...
	return ".beads" // fallback: create in cwd
}
	...
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			fmt.Printf("Period:     %s .. %s\n",
				sum.FirstSession.Format("2006-01-02"),
				sum.LastSession.Format("2006-01-02"))
			return nil
		},
	}
}
